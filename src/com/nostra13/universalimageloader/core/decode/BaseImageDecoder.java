...
public class BaseImageDecoder implements ImageDecoder {
    ...
    protected ImageFileInfo defineImageSizeAndRotation(InputStream imageStream, String imageUri)
            throws IOException {
    ...
    protected Options prepareDecodingOptions(ImageSize imageSize, ImageDecodingInfo decodingInfo) {
        ...
        if (scaleType != ImageScaleType.NONE) {
            ...
            if (loggingEnabled)
                L.i(LOG_SABSAMPLE_IMAGE, imageSize, imageSize.scaleDown(scale), scale,
    ...
    protected Bitmap decodeStream(InputStream imageStream, Options decodingOptions)
            throws IOException {
        try {
