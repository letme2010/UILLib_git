 ...
 * {@link ImageDownloader#getStream(java.net.URI, Object) ImageDownloader}</li>
...
public final class DisplayImageOptions {
    ...
    private final Drawable stubImage;
    ...
    public static class Builder {
         ...
         */
        public Builder showStubImage(Drawable stubImageRes) {
         ...
         * @param imageRes Image resource
         */
        public Builder showImageOnFail(Drawable imageRes) {
         ...
         * {@link ImageDownloader#getStream(java.net.URI, Object)}
         */
